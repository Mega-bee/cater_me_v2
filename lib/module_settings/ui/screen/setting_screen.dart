...
import 'package:cater_me_v2/module_notification/notification_route.dart';
...
class SettingScreen extends StatefulWidget {
  ...
  SettingScreen(this._authService, this._localizationService,
      this._themeDataService, this.cubit);
            ...
            children: [
              Stack(
                ...
                children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              IconBackCard(
                                  ...
                                  onTapCard: () {
                                    Navigator.pushNamed(context, NotificationRoutes.VIEW_NOTIFICATION);
                                  }),
                              IconBackCard(
                                  ...
                                  onTapCard: () {
                                    Navigator.pushNamed(
                                        context, OrderRoutes.VIEW_ORDERS);
                                  }),
                              IconBackCard(
                  ...
                  widget._authService.isLoggedIn ? Container():  Padding(
              ...
              widget._authService.isLoggedIn
                  ? InkWell(
                onTap: (){
                  widget._authService.logout().then((value) => Navigator.pushNamed(context, AuthorizationRoutes.LOGIN_SCREEN));
                },
                    child: Padding(
                        padding: const EdgeInsets.all(18.0),
                        child: Container(
              ...
              SizedBox(height: 5,),
              BlocBuilder<ContactCubit, States>(
                bloc: widget.cubit,
                builder: (context, state) => state.getUI(context),
              )
            ],
          ),
        ));
